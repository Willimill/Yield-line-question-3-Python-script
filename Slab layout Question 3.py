...
q=int((W/step)+1)
z=len(ratio_list)
empty_array= np.zeros((q,v))
empty_array_2= np.zeros((q,v))
...
# =============================================================================
user_result_x=[4.5,1.5,2.4,3,3.8,1.9,2,4,2.5,2,4]
user_result_y=[1.5,1.5,2.8,3,2.9,1.9,3.5,1,3,3.5,4]
staff_result_x=[2,2.3,2]
staff_result_y=[6,2,2.5]
eng_result_x=[2.5,2,2]
eng_result_y=[3.5,3,3]
# =============================================================================
# #Section 8 - Creating contour plot of slab to show optimisation and scatter plot to illustrate users input
# =============================================================================
xlist = np.linspace(0, L, v)
ylist = np.linspace(0, W, q)
...
plt.scatter(user_result_x,user_result_y, c ='indigo', label='student')
